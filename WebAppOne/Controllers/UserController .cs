...
namespace NewsPortal.Web.Controllers
{
    ...
    ///3.Поддержка атрибутов для валидации: Вы можете использовать атрибуты данных, такие как[Required -  необходимый, обязательный], 
    ///[MaxLength], [Range - диапозон] и другие, чтобы определить правила валидации модели входных данных.Эти атрибуты 
